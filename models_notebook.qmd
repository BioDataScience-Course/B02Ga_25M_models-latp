...
```{rgrapmodel1Lea-Amelie}

```

```{rresiduals1Lea-Amelie}
...
```{rgraphmodel2Thea-Pierre}

```

```{rresiduals2Thea-Pierre}
...
```{rgraphGLM(M)1Lea-Amelie}
```

\`\`\`{rresidualsGLM(M)1Lea-Amelie}
...
\`\`\`{rgraphGLM(M)2Thea-Pierre}

```         

```{rresidualsGLM(M)2Thea-Pierre}
```
