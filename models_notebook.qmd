...
-   La taille corporelle (SVL) influence fortement le sexe des individus. Plus un individu est grand, plus la probabilité qu’il soit un mâle est élevée. Cet effet es fortement significatif sur le plan statistique.
...
-   On observe une relation positive claire entre la taille (SVL) et la largeur du corps. Quand la SVL augmente, la largeur du corps augmente aussi.

-   Sur une échelle log–log, cela indique une relation allométrique (croissance proportionnelle).

-   La taille corporelle est un bon prédicteur de la largeur du corps, chez les deux sexes.

-   À taille égale, les femelles ont en moyenne un corps plus large que les mâles.

-   Les points sont relativement proches des lignes. Il existe une dispersion normale autour de la relation moyenne
