...
Dans la recherche des deux meilleurs modèles, le modèle snake_lm1 et le snake1_lm sont rejetés car leur AIC est beacoup plus élevé que les autres.
...
Le modèle snake_glm1 est aussi choisi car il suit une gaussienne tandis que snake_glm2 suit une binomiale que nous ne sommes pas capable, à notre niveau, d'analyser.
