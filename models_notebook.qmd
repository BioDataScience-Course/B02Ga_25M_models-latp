...
-   L'effet est positif et hautement significatif
...
#Test 2 
sn2<- glm(data = sea_snake1,body_width ~ svl + sex,
  family = Gamma(link = "log"))
...
sn3 <- glm(data = sea_snake1, sex_bin ~ svl + tail_length + body_width + tail_width_max + species,
